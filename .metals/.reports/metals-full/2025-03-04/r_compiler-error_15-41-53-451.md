...
public class Aboutus {
    ...
    public void confirmContactInfo() {
        String sidecardText = driver.findElement(By.tagName("body")).getText();
    ...
    public void confirmHours() {
		String sidecardText = driver.findElement(By.id(databank.infoId)).getText();
	...
	public void confirmOurHistory() {
		String bodyText = driver.findElement(By.id(databank.aboutUsContentId)).getText();
