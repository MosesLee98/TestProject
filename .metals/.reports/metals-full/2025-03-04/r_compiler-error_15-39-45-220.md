...
public class Databank {
    ...
    // About us Text
    public String aboutUsContentId = "textarea";
    ...
    public String awardWinningText = "Time's Rea@@ders Choice awards for Best Thai Restaurant in Pitt Meadows/Maple Ridge in 2011.";
