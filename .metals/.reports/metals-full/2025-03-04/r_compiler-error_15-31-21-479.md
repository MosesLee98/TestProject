...
public class Databank {
    ...
    public String aboutus@@URL = "http://www.padthairestaurant.ca/aboutus.php";
    ...
    // About us Text
    public String ourHistory = "Sisters Jenny and Jessie Trakulthongroj have owned and operated the Pad Thai Restaurant in Pitt Meadows, BC since 1999.";
    public String awardWinning = "Time's Readers Choice awards for Best Thai Restaurant in Pitt Meadows/Maple Ridge in 2011.";
