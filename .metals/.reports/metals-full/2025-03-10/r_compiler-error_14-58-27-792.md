...
public class Contact {
    ...
    public void submitContactUsForm() {
        ...
        // press submit button
        WebElement formSubmitdriver.findElement(By.xpath("//input[@type='submit' and @value='Submit']"));
        Assert.assertTrue(driver.findElement(By.xpath("//input[@type='submit' and @value='Submit']")))
    }
}
```
