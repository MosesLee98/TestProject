...
public class Contact {
    ...
    public void contactUsFormSuccess() {
        ...
        wait.until(ExpectedConditions.urlToBe("ht@@tps://example.com/dashboard"));
        System.out.println("Navigated to the expected URL.");
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(driver.getCurrentUrl() == databank.sendFormURL);
