...
### java.lang.AssertionError: assertion failed: position not set for <error> # -1 of class dotty.tools.dotc.ast.Trees$Ident in <WORKSPACE>/src/test/java/Contact.java
...
public class Contact {
    ...
    // Ensure contact us form is available and submittable
    @
}
```
