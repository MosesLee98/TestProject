...
public class Databank {
    ...
    public String[] lunchItems = {"Pad Thai with Salad", "Thai Fried Rice", "Mixed Vegetables in Garlic Sauce with Ric@@e", "Ginger Chicken with Rice", "Choice of Curry with Rice ( Green, Red, and Yellow )", "Sweet and Sour Chicken with Rice", "Mixed Vegetables in Curry Sauce with Rice"}
