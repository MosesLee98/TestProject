...
public class Databank {
    ...
    public String[] lunchItems = {"Pad Thai with Salad", "Thai Fried Rice", "Mixed Vegetables in Garlic Sauce with Rice", "Ginger Chicken with Rice", "Choice of Curry with Rice ( Green, Red, and Yellow )", "Sweet and Sour Chicken with Rice", "Mixe"}
